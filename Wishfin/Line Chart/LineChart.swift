...
class LineChart: UIView {
    ...
    private func setupView() {
        ...
        // Change here for gradient color
        gradientLayer.colors = [#colorLiteral(red: 0, green: 0.7411764706, blue: 0.6666666667, alpha: 0.32).cgColor,#colorLiteral(red: 1, green: 1, blue: 1, alpha: 0).cgColor ]
    ...
    private func drawCurvedChart() {
        ...
        if let path = CurveAlgorithm.shared.createCurvedPath(dataPoints) {
            let lineLayer = CAShapeLayer()
            lineLayer.path = path.cgPath
            // Change here for curved color
            lineLayer.strokeColor = #colorLiteral(red: 0, green: 0.7411764706, blue: 0.6666666667, alpha: 1).cgColor
            lineLayer.fillColor = UIColor.clear.cgColor
            dataLayer.addSublayer(lineLayer)
        }
    }
    ...
    private func drawLables() {
        if let dataEntries = dataEntries,
            ...
            for i in 0..<dataEntries.count {
                ...
                // Change here for label color
                textLayer.foregroundColor = #colorLiteral(red: 0.5294117647, green: 0.5960784314, blue: 0.6784313725, alpha: 1).cgColor
